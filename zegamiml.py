...
parser.add_argument('-f','--format', help="Input file format. Image or Matrix", required=False, default="Image")
parser.add_argument('-c','--image_column', help='Column name in TSV that contains the image name',required=False)
parser.add_argument('-d','--image_dir', help='Directory that contains all the images.',required=False)
